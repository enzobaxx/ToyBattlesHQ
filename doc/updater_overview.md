...
## Next
[7.2 Changing the client version (using the client version tool)](https://github.com/DownWithTheFallen/ToyBattlesHQ/blob/toybattles_mvsurge/doc/client_version_tool.md)
