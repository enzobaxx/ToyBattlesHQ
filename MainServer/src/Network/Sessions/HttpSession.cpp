...
namespace Main
{
    namespace Network
    {
        bool HttpSession::verifyTokenAndGrade(const std::string& token, const std::string& secret, std::uint32_t requiredGrade)
        {
            try
            {
        ...
        std::optional<std::string> HttpSession::extractToken(const http::request<http::string_body>& request)
        {
        ...
        bool HttpSession::validateRequest(const http::request<http::string_body>& m_request,
        ...
        void HttpSession::sendResponse(const std::string& body, http::status statusCode)
        {
        ...
        bool HttpSession::isOriginOk(const std::string& origin)
        {
       ...
       */
        void HttpSession::handleBanCommand(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
        ...
        /*
           ...
           Response body: contains message (success or error)
       */
        void HttpSession::handleMute(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
        ...
        */
        void HttpSession::handleAnnounceCommand(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request, bool isTip)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
        ...
        /*
             ...
             - 500: server exception
        */
        void HttpSession::getOnlinePlayers(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
        ...
        /*
            ...
            - 500: server exception
        */
        void HttpSession::handleDisconnect(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
        ...
        /*
            ...
            - 500: server exception
        */
        void HttpSession::handleGetRooms(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
        ...
        */
        void HttpSession::handleBreakroom(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
        ...
        void HttpSession::handleKick(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
                ...
                {
                    auto roomNum = targetSession->getPlayer().matchContext.roomNumber;
        ...
        void HttpSession::handleHostChange(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
                ...
                if (auto targetSession = m_sessionsManager.findSessionByName(targetNickname))
                {
                    if (auto* room = m_roomsManager.getRoomByNumber(targetSession->getPlayer().matchContext.roomNumber))
                    {
                    ...
                    {
                        responseBody = std::format("Room number '{}' not found", targetSession->getPlayer().matchContext.roomNumber);
                        statusCode = http::status::not_found;
                    }
                }
                else
        ...
        void HttpSession::handleRoomTitleChange(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
        ...
        /*
            ...
            (see header docs)
        */
        void HttpSession::handleGetRoomInfo(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
        ...
        /*
            ...
            (see header docs)
        */
        void HttpSession::handleGetPlayerInfo(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                boost::json::object obj;
                ...
                if (targetSession)
                {
                    ...
                    playerObj["CurrentRoom"] = targetSession->getPlayer().matchContext.roomNumber;
        ...
        /*
           Reward giftbox. See header for body schema and return codes.
        */
        void HttpSession::handleReward(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
        ...
        /*
            Capsule event update. See header for body schema.
        */
        void HttpSession::handleCapsuleEvent(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
        ...
        void HttpSession::handleTradeEvent(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
        ...
        void HttpSession::handleEventMission(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            handleGenericEventInfoUpdate(
                responseBody,
                statusCode,
        ...
        /*
            ExpMp bonus update. See header for body schema.
        */
        void HttpSession::handleExpMpBonus(std::string& responseBody, http::status& statusCode, const http::request<http::string_body>& m_request)
        {
            try
            {
                auto tokenOpt = extractToken(m_request);
